...
async def create_campaign(
    ...
    return await email_service.create_campaign(current_user["id"], campaign.dict())
...
async def update_campaign(
    ...
    return await email_service.update_campaign(current_user["id"], campaign_id, updates)
...
async def add_contacts_to_list(
    ...
    return await email_service.add_contacts_to_list(current_user["id"], list_id, [c.dict() for c in contacts])
...
async def get_automations(current_user: dict = Depends(get_current_user)):
    ...
    return await email_service.get_automations(current_user["id"])
