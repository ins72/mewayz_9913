...
trait HasPlans
{
    ...
    public function subscribeTo($plan, int $duration = 30, bool $isRecurring = true)
    {
        ...
        if ($this->subscriptionPaymentMethod == 'stripe') {
            try {
                ...
                event(new \App\Plans\Events\Stripe\ChargeSuccessful($this, $subscription, $stripeCharge));
            } catch (\Exception $exception) {
                event(new \App\Plans\Events\Stripe\ChargeFailed($this, $subscription, $exception));
            }
        }

        event(new \App\Plans\Events\NewSubscription($this, $subscription));
    ...
    public function subscribeToUntil($plan, $date, bool $isRecurring = true)
    {
        ...
        event(new \App\Plans\Events\NewSubscriptionUntil($this, $subscription, $date));
    ...
    public function upgradeCurrentPlanTo($newPlan, int $duration = 30, bool $startFromNow = true, bool $isRecurring = true)
    {
        ...
        event(new \App\Plans\Events\UpgradeSubscription($this, $subscription, $startFromNow, $oldPlan, $newPlan));
    ...
    public function upgradeCurrentPlanToUntil($newPlan, $date, bool $startFromNow = true, bool $isRecurring = true)
    {
        ...
        event(new \App\Plans\Events\UpgradeSubscriptionUntil($this, $subscription, $date, $startFromNow, $oldPlan, $newPlan));
    ...
    public function extendCurrentSubscriptionWith(int $duration = 30, bool $startFromNow = true, bool $isRecurring = true)
    {
        ...
        if ($startFromNow) {
            ...
            event(new \App\Plans\Events\ExtendSubscription($this, $activeSubscription, $startFromNow, null));
        ...
        event(new \App\Plans\Events\ExtendSubscription($this, $activeSubscription, $startFromNow, $subscription));
    ...
    public function extendCurrentSubscriptionUntil($date, bool $startFromNow = true, bool $isRecurring = true)
    {
        ...
        if ($startFromNow) {
            ...
            event(new \App\Plans\Events\ExtendSubscriptionUntil($this, $activeSubscription, $date, $startFromNow, null));
        ...
        event(new \App\Plans\Events\ExtendSubscriptionUntil($this, $activeSubscription, $date, $startFromNow, $subscription));
    ...
    public function cancelCurrentSubscription()
    {
        ...
        // Cancel on api too.
        if($checkout = CheckoutGo::where('uref', $this->last_subscription_uref)->first()){
            ...
            if($checkout->payment_type == 'recurring' && $config){
                ...
                $this->last_subscription_uref = null;
                $this->save();
            }
        }
        ...
        event(new \App\Plans\Events\CancelSubscription($this, $activeSubscription));
