                ...
                <div style="border-bottom:1px solid #f5f5f5;border-top:6px solid black;border-radius:7px 7px 0 0;background:#ffffff;margin:0px auto;max-width:582px">
                        ...
                        <div style="border-left:1px solid #f5f5f5;border-right:1px solid #f5f5f5;direction:ltr;font-size:0px;padding:8px 30px;text-align:center">
                            <div style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%">
                                <div style="background-color:#ffffff;padding:10px 0px">
                                    <div style="font-family:Helvetica,Arial,sans-serif;font-size:14px;line-height:18px;text-align:left;color:#4c4c4c">
                                        {!! __t('You have received an invoice from :name. Click <a style="color:#2a9edb;font-weight:500;text-decoration:none" href=":link">here</a> to view the details and make the payment by :date.', [
                                            'name' => ao($invoice->data, 'name'),
                                            'date' => \Carbon\Carbon::parse($invoice->due)->toFormattedDateString(),
                                            'link' => route('out-invoice-single', [
                                                'slug' => $invoice->slug,
                                            ])
                                        ]) !!}
                                    </div>
                    ...
                    <div style="background:#ffffff;margin:0px auto;max-width:582px">
                        <div style="border-left:1px solid #f5f5f5;border-right:1px solid #f5f5f5;direction:ltr;font-size:0px;padding:8px 30px;text-align:center">
                            <div style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%">
                                <div style="background-color:#ffffff;padding:10px 0px">
                                    <div align="center" style="font-size:0px;padding:8px 0px;word-break:break-word">
                                        <div align="center" bgcolor="#009940" role="presentation" style="border:none;border-radius:4px;background:#000000">
                                            <a style="display:inline-block;background:#000000;color:#ffffff;font-family:Helvetica,Arial,sans-serif;font-size:14px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 20px;border-radius:4px" href="{{ route('out-invoice-single', [
                                                'slug' => $invoice->slug,
                                            ]) }}">{{ __('Pay Invoice') }}</a>
                                        </div>
                                    </div>
