<div>
   <div x-data="builder__bankcrypto_item__single">
             ...
             <div class="flex-auto">
               <div class="flex items-end gap-3">
                 <div class="flex flex-col gap-2 grow shrink">
                    <div >
                       <div>
                            <input placeholder="{{ __('Title') }}" x-model="item.content.title" type="text" class="text-gray-600 p-0 overflow-hidden text-ellipsis !min-h-[21px]">
                        </div>
                    </div>
                    <div >
                       <div>
                            <input placeholder="{{ __('Wallet Number') }}" x-model="item.content.wallet" type="text" class="text-gray-600 p-0 overflow-hidden text-ellipsis min-h-[21px] !border-0 !border-b border-solid border-gray-200 rounded-lg resize-none p-2">
                        </div>
                    </div>
                 </div>
                 <div role="button" tabindex="0" class="cursor-pointer bg-gray-200 hover:opacity-70 flex items-center justify-center rounded-8 shrink-0 h-14 w-14" @click="openMedia({
   ...
   @script
   <script>
       Alpine.data('builder__bankcrypto_item__single', () => {
          return {
