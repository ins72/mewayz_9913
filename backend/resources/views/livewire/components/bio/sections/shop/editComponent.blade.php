<div wire:ignore>
    ...
    <div x-data="builder__sectionList">

        <div x-show="__page == 'add'">
            <div>
                <x-livewire::components.bio.sections.shop.partial.add />
            </div>
        </div>
        <template x-if="_editSection">
            <div x-data="{item:_editSection}">
                <x-livewire::components.bio.sections.shop.partial.edit.single />
            </div>
        </template>
        {{-- <template x-for="(item, index) in section.items" :key="item.uuid">
            <div x-show="__page == 'section::image::' + item.uuid">
                <div>
                    <x-livewire::components.bio.sections.image.partial.edit.single />
                </div>
            </div>
        </template> --}}
        ...
        <div x-cloak x-show="__page == '-' && !_editSection">
          <div class="banner-section !block">
              <div>
                  ...
                  <div class="container-small tab-content-box ![overflow:initial] lg:!overflow-y-auto">
                      <div class="tab-content">
                          <div x-cloak x-show="__tab == 'content'" data-tab-content>
                            <x-livewire::components.bio.sections.shop.partial.edit.content/>
                          </div>
                          <div x-cloak x-show="__tab == 'style'" data-tab-content>
                            <x-livewire::components.bio.sections.shop.partial.edit.style/>
                          </div>
                      </div>
                  </div>
              </div>
  ...
  @script
  <script>
      Alpine.data('builder__sectionList', () => {
         return {
            autoSaveTimer: null,
            __tab: 'content',
            __page: '-',
