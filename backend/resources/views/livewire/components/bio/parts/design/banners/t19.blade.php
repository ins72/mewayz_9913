<div class="w-[100%]">
    <div class="flex flex-col w-[100%] p-2">
        <div class="flex items-cente relative overflow-hidden justify-start">
        ...
        <div class="flex items-center mt-2 relative overflow-hidden justify-center">
            ...
            <div class="h-10 w-10 bg-gray-200 p-3 border-2 border-white border-solid rounded-lg !bg-cover !bg-center" :style="{
                'background': site.banner ? `url(${$store.builder.getMedia(site.banner)})` : 'rgb(238 238 238/1)'
            }"></div>
