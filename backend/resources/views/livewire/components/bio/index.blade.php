               ...
               <div class="builder-layout-root-main" :style="{
                  ...
                  <div class="builder-sections-o relative z-[5] pb-10" :class="{
                     ...
                     <template x-for="(item, index) in window._.sortBy(getSections(), 'position')" :key="item.id">
                        <div class="w-[100%] bio-margin -animated bio-block-wrapper" :id="'block-id-' + item.id" :data-block-id="item.id" :style="{
                           '--accent': site.background.section_color_enable == 'enable' ? site.settings.section_color : '',
                           '--bg-contrast-color': site.background.section_color_enable == 'enable' ? $store.builder.getContrastColor(site.settings.section_color) : ''
                        }" :class="{
                           '--enable-bg': site.background.section_color_enable == 'enable',
                           'rounded-none': site.background.section_color_enable == 'enable' ? site.settings.corners == 'straight' : false,
                           'rounded-xl':  site.background.section_color_enable == 'enable' ? site.settings.corners == 'round' : false,
                           'rounded-3xl': site.background.section_color_enable == 'enable' ? site.settings.corners == 'rounded' : false,
                        }">
                           <template x-if="item.content.title || item.content.subtitle">
                              <div class="flex">
                                 <div class="bio-titles z-50 flex flex-col gap-2 w-[100%]" :class="{
                                    'items-start': site.settings.align == 'left',
                                    'items-center': site.settings.align == 'center',
                                    'items-end': site.settings.align == 'right',
                                 }">
                                    <template x-if="item.content.title">
                                       <div class="heading !m-0" :class="{
                                          'text-left': site.settings.align == 'left',
                                          'text-center': site.settings.align == 'center',
                                    ...
                                    <template x-if="item.content.subtitle">
                                       <div class="heading !m-0" :class="{
                                          ...
                                          'text-center': site.settings.align == 'center',
                                          'text-right': site.settings.align == 'right',
                                       }" x-text="item.content.subtitle"></div>
                                    </template>
                                 </div>
                           </div>
                           </template>
