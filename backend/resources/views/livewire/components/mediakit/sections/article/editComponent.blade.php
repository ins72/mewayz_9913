<div >
    <div x-data="builder__sectionArticle">
            ...
            <div class="website-section !block">
                <div class="design-navbar">
                    <ul >
                       ...
                       <li class="!pl-0" x-text="!section.content.title ? '{{ __('Article') }}' : section.content.title"></li>
                    ...
                    <div class="tab-content-box mt-0">
                        <div class="tab-content">
                            <div x-cloak x-show="__tab == 'content'" data-tab-content>
                                <x-livewire::components.bio.sections.article.partial.edit.content/>
                            </div>
                            <div x-cloak x-show="__tab == 'style'" data-tab-content>
                                <x-livewire::components.bio.sections.article.partial.edit.style/>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  @script
  <script>
      Alpine.data('builder__sectionArticle', () => {
         return {
            autoSaveTimer: null,
            __tab: 'content',
            __page: '-',
