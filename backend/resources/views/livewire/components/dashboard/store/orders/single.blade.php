<?php
    ...
    $get = function(){
        ...
        if($this->order_id){
            $this->order = ProductOrder::where('user_id', $this->user->id);
    ...
    $getTimeline = function(){
        ...
        $this->timeline = ProductOrderTimeline::where('tid', $this->order->id)->where('user_id', $this->user->id)->orderBy('id', 'DESC')->get();
    };
