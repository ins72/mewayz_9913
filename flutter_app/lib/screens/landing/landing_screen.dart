          ...
          ResponsiveLayout(
            mobile: Column(
              children: [
                ...
                const SizedBox(height: 40),
                _buildDemoItem('Web Dashboard', 'Full-featured desktop experience with advanced analytics.', 'https://4b3480db-9b06-4815-a43a-ac19f3fb2ea8.preview.emergentagent.com/'),
              ],
            ),
            tablet: Row(
              children: [
                ...
                const SizedBox(width: 40),
                Expanded(
                  child: _buildDemoItem('Web Dashboard', 'Full-featured desktop experience with advanced analytics.', 'https://4b3480db-9b06-4815-a43a-ac19f3fb2ea8.preview.emergentagent.com/'),
                ),
              ],
            ),
            desktop: Row(
