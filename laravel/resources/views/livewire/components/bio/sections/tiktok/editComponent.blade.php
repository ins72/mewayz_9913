<?php
   ...
   $fetch = function($link){
        ...
        $yt_rx = '/http(?:s)?:\/\/(?:www\.)?tiktok\.com\/([a-zA-Z0-9_@]+)/';
        $has_match_tiktok = preg_match($yt_rx, $link, $yt_matches);
    
    
        // Flash Message
        if (!$has_match_tiktok) return;
...
?>
<div >
    <div x-data="builder__sectionTiktok">
            ...
            <div class="website-section !block">
                <div class="design-navbar">
                    <ul >
                       ...
                       <li class="!pl-0" x-text="!section.content.title ? '{{ __('Tiktok') }}' : section.content.title"></li>
                    ...
                    <div class="container-small tab-content-box mt-0 ![overflow:initial] lg:!overflow-y-auto">
                        <div class="tab-content">
                            <div x-cloak x-show="__tab == 'content'" data-tab-content>
                                <x-livewire::components.bio.sections.tiktok.partial.edit.content/>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  @script
  <script>
      Alpine.data('builder__sectionTiktok', () => {
         return {
            autoSaveTimer: null,
            __tab: 'content',
            __page: '-',
