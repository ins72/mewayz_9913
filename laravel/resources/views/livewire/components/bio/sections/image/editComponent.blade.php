<div >
    <div x-data="builder__sectionImage">
            ...
            <div class="website-section !block">
                <div class="design-navbar">
                    <ul >
                       ...
                       <li class="!pl-0" x-text="!section.content.title ? '{{ __('Image') }}' : section.content.title"></li>
                    ...
                    <div class="container-small tab-content-box mt-0 ![overflow:initial] lg:!overflow-y-auto">
                        <div class="tab-content">
                            <div x-cloak x-show="__tab == 'content'" data-tab-content>
                                <x-livewire::components.bio.sections.image.partial.edit.content/>
                            </div>
                            <div x-cloak x-show="__tab == 'style'" data-tab-content>
                                {{-- <x-livewire::components.bio.sections.image.partial.edit.style/> --}}
                            </div>
  ...
  @script
  <script>
      Alpine.data('builder__sectionImage', () => {
         return {
            autoSaveTimer: null,
            __tab: 'content',
            __page: '-',
