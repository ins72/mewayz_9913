<?php
   ...
   $fetch = function($link){
        ...
        $yt_rx = '/http(?:s)?:\/\/(?:www\.)?twitter\.com\/([a-zA-Z0-9_]+)/';
        $has_match_twitter = preg_match($yt_rx, $link, $yt_matches);
    
    
        // Flash Message
        if (!$has_match_twitter) return;
...
?>
<div >
    <div x-data="builder__sectionTwitter">
            ...
            <div class="website-section !block">
                <div class="design-navbar">
                    <ul >
                       ...
                       <li class="!pl-0" x-text="!section.content.title ? '{{ __('Twitter') }}' : section.content.title"></li>
                    ...
                    <div class="container-small tab-content-box mt-0 ![overflow:initial] lg:!overflow-y-auto">
                        <div class="tab-content">
                            <div x-cloak x-show="__tab == 'content'" data-tab-content>
                                <x-livewire::components.bio.sections.twitter.partial.edit.content/>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  @script
  <script>
      Alpine.data('builder__sectionTwitter', () => {
         return {
            autoSaveTimer: null,
            __tab: 'content',
            __page: '-',
