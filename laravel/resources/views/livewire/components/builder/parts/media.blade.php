...
<div x-data="media__section">
    <div class="media-section">
        ...
        <div class="container-small sticky">
            <div class="tab-link">
                <ul class="tabs">
                <li class="tab !w-full" @click="__tab = 'uploads'" :class="{'active': __tab == 'uploads'}">{{ __('Uploads') }}</li>
                <li class="tab !w-full" @click="__tab = 'unsplash'" :class="{'active': __tab == 'unsplash'}">{{ __('Unsplash') }}</li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="device-library">
                       ...
                       x-on:livewire-upload-progress="progress = $event.detail.progress">
                          <div class="upload-card relative">
                            ...
                            <input type="file" wire:model="image" name="image" class="absolute right-0 top-0 w-full h-full opacity-0">
