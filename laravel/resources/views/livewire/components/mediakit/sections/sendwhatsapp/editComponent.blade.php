<div >
    <div x-data="builder__sectionSendWhatsapp">
            ...
            <div class="website-section !block">
                <div class="design-navbar">
                    <ul >
                       ...
                       <li class="!pl-0" x-text="!section.content.title ? '{{ __('SendWhatsapp') }}' : section.content.title"></li>
                    ...
                    <div class="tab-content-box mt-0">
                        <div class="tab-content">
                            <div x-cloak x-show="__tab == 'content'" data-tab-content>
                                <x-livewire::components.bio.sections.sendwhatsapp.partial.edit.content/>
                            </div>
                            <div x-cloak x-show="__tab == 'style'" data-tab-content>
                                <x-livewire::components.bio.sections.sendwhatsapp.partial.edit.style/>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  @script
  <script>
      Alpine.data('builder__sectionSendWhatsapp', () => {
         return {
            autoSaveTimer: null,
            __tab: 'content',
            __page: '-',
