...
use Carbon\Carbon;
use App\Models\Base\PlansSubscription as BasePlansSubscription;

class PlansSubscription extends BasePlansSubscription
{
	protected $fillable = [
		'plan_id',
		'model_id',
    ...
    public function getRemainingDays(){
        ...
        if($this->plan->is_free) return __('Forever');
    ...
    public function consumeFeature(string $featureCode, float $amount)
    {
        ...
        event(new \Iprop\Plans\Events\FeatureConsumed($this, $feature, $amount, $remaining));
