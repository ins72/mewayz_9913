<div class="banner-layout-3 w-boxed">
   <div class="banner section-component">
    ...
    <div class="banner-text content-heading" :class="{
      ...
      <template x-if="post.settings.enable_image">
        <div class="section-item-image banner-image min-shape" :class="{'default': !post.content.image}" :style="{
            'height': post.settings.height + 'px',
            '--height': post.settings.height + 'px'
            }">
