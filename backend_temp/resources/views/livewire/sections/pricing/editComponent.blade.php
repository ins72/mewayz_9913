<div wire:ignore>
 ...
 <div x-data="builder__sectionPricing">
    ...
    <template x-for="(item, index) in section.items" :key="item.uuid">
      <div x-show="__page == 'section::pricing::' + item.uuid">
          <div>
              <x-livewire::sections.pricing.partial.edit.items />
          </div>
      </div>
    </template>
              ...
              <div class="container-small tab-content-box">
                  <div class="tab-content">
                      <div x-cloak x-show="__tab == 'content'" data-tab-content>
                          <x-livewire::sections.pricing.partial.edit.content/>
                      </div>
                      <div x-cloak x-show="__tab == 'style'" data-tab-content>
                          <x-livewire::sections.pricing.partial.edit.style />
                      </div>
                  </div>
              </div>
          </div>
  ...
  @script
  <script>
      Alpine.data('builder__sectionPricing', () => {
         return {
            autoSaveTimer: null,
            __tab: 'content',
            __page: '-',
            ...
            registerEvents(){
                ...
                window.addEventListener('section:i:' + this.section.uuid, (event) => {
                    $this.__page = 'section::pricing::' + event.detail;
                });
