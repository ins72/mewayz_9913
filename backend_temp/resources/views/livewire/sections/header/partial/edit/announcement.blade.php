    ...
    <div class="website-section">
        <div class="design-navbar">
           <ul >
              ...
              <li class="!pl-0">{{ __('Announcement') }}</li>
              <li></li>
           </ul>
        </div>
         ...
         <form class="form-panel" onsubmit="return false">
            <div class="input-box">
               ...
               <div class="input-group button-input-group">
                  <input type="text" class="input-small button-text" x-model="site.header.announcement_text" placeholder="{{ __('Announcement Text') }}">
                  <div class="link-options__container second mt-1">
                     
                     <x-builder.input>
                        <div class="link-options__main relative">
                           <input class="input-small main__link" type="text" x-model="site.header.announcement_link" placeholder="{{ __('Search site or paste link') }}" x-on:input="filter()">
                        </div>
                     </x-builder.input>
                  </div>
               </div>
