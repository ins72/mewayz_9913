<div wire:ignore>
    <div x-data="builder__sectionCards">
        ...
        <template x-for="(item, index) in section.items" :key="item.uuid">
          <div x-show="__page == 'section::cards::' + item.uuid">
              <div>
                  <x-livewire::sections.cards.partial.edit.items />
              </div>
          </div>
        </template>
                  ...
                  <div class="container-small tab-content-box">
                      <div class="tab-content">
                          <div x-cloak x-show="__tab == 'content'" data-tab-content>
                              <x-livewire::sections.cards.partial.edit.content/>
                          </div>
                          <div x-cloak x-show="__tab == 'style'" data-tab-content>
                              <x-livewire::sections.cards.partial.edit.style />
                          </div>
                      </div>
                  </div>
              </div>
  ...
  @script
  <script>
      Alpine.data('builder__sectionCards', () => {
         return {
            autoSaveTimer: null,
            __tab: 'content',
            __page: '-',
            ...
            createItem(){
                ...
                let item = {
                    ...
                    content: {
                        'image': null,
                        'title': '{{ __('Card') }}'+' '+($this.section.items.length+1),
            ...
            registerEvents(){
                ...
                window.addEventListener('section:i:' + this.section.uuid, (event) => {
                    $this.__page = 'section::cards::' + event.detail;
                });
