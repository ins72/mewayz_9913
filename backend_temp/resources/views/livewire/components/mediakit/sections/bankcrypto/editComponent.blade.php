<div >
    <div x-data="builder__sectionBankcrypto">
                    ...
                    <div class="container-small tab-content-box mt-0 ![overflow:initial] lg:!overflow-y-auto">
                        <div class="tab-content">
                            <div x-cloak x-show="__tab == 'content'" data-tab-content>
                                <x-livewire::components.bio.sections.bankcrypto.partial.edit.content/>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  @script
  <script>
      Alpine.data('builder__sectionBankcrypto', () => {
         return {
            autoSaveTimer: null,
            __tab: 'content',
            __page: '-',
