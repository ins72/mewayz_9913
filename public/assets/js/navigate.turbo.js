...
navigateTurbo.init = (config) => {
	...
	navigateTurbo.runNavigateFunction = config.runNavigateFunction;
	navigateTurbo.runFunctionInit = config.runFunctionInit;
...
navigateTurbo.registerListeners = () => {
	...
	document.addEventListener("livewire:navigated", () => {
		//console.log(navigateTurbo)

		navigateTurbo.runNavigateFunction();
	});
