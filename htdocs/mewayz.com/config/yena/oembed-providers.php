...
return [
    ...
    'regex_providers' => [
        'apple_music' => [
            'ssl' => true,
            'urls' => [
                '~^https?://music.apple\.com/([a-zA-Z0-9-_/?=]+)~imu',
            ],
            'data' => [
                'type' => 'video',
                'provider_name' => 'Apple Music',
                'provider_url' => 'https://music.apple.com',
                'html' => [
                    'iframe' => [
                        'src' => '{protocol}://embed.music.apple.com/{1}',
                    ],
                ],
            ],
        ],
        'beatport' => [
            'ssl' => true,
            'urls' => [
                '~^https?://(?:www\.)?beatport\.com/track/([a-zA-Z0-9-_/?=]+)/([a-zA-Z0-9-_/?=]+)~imu',
            ],
            'data' => [
                'type' => 'video',
                'provider_name' => 'Beat Port',
                'provider_url' => 'https://beatport.com',
                'html' => [
                    'iframe' => [
                        'src' => '{protocol}://embed.beatport.com/?id={2}&type=track',
                    ],
                ],
            ],
        ],
        'traxsource' => [
            'ssl' => true,
            'urls' => [
                '~^https?://(?:www\.)?traxsource\.com/track/([a-zA-Z0-9-_/?=]+)/([a-zA-Z0-9-_/?=]+)~imu',
            ],
            'data' => [
                'type' => 'video',
                'provider_name' => 'Beat Port',
                'provider_url' => 'https://traxsource.com',
                'html' => [
                    'iframe' => [
                        'src' => '{protocol}://embed.traxsource.com/player/track/{1}',
                    ],
                ],
            ],
        ],
