         ...
         <form>
            ...
            <template x-if="section.settings.display == 'grid'">
               <div class="input-box" x-data="{__showing: 'desktop'}">
                  ...
                  <div class="input-group">
                     ...
                     <input type="range" class="input-small range-slider !rounded-l-none" :class="{'!hidden': __showing !== 'desktop'}" min="2" max="5" step="1" x-model="section.settings.desktop_grid">
                     <input type="range" class="input-small range-slider !rounded-l-none" :class="{'!hidden': __showing !== 'mobile'}" min="2" max="5" step="1" x-model="section.settings.mobile_grid">
            ...
            <template x-if="section.settings.display == 'carousel'">
               <div class="input-box" x-data="{__showing: 'desktop'}">
                  ...
                  <div class="input-group">
                     ...
                     <input type="range" class="input-small range-slider !rounded-l-none" :class="{'!hidden': __showing !== 'desktop'}" min="50" max="400" step="10" x-model="section.settings.desktop_width">

                     <input type="range" class="input-small range-slider !rounded-l-none" :class="{'!hidden': __showing !== 'mobile'}" min="50" max="400" step="10" x-model="section.settings.mobile_width">
            ...
            <div class="input-box" x-data="{__showing: 'desktop'}">
               ...
               <div class="input-group">
                  ...
                  <input type="range" class="input-small range-slider !rounded-l-none" :class="{'!hidden': __showing !== 'desktop'}" min="40" max="150" step="10" x-model="section.settings.desktop_height">

                  <input type="range" class="input-small range-slider !rounded-l-none" :class="{'!hidden': __showing !== 'mobile'}" min="40" max="150" step="10" x-model="section.settings.mobile_height">
