<div class="w-[100%] section-width-fill section-bg-wrapper list-box ![background:transparent]" :class="{
   ...
   <div x-data="builder__productSectionView">
      <div class="goods-sell-group--container" :class="{
         ...
         <template x-for="(item, index) in window._.sortBy(section.items, 'position')" :key="item.uuid">
            <div class="goods-sell--container goods-sell-group--elem goods-sell-group--item" x-data="{product: getProduct(item.content.product_id)}" :class="{
               ...getClasses,
               'goods-sell-group--firstGrid': (index + 1) % 3 === 1 && section.settings.style == 'bn-10'
            }" style="--goods-text-align: LEFT;">
               <div class="card--container card--background-color" style="height: 100%; overflow: hidden; --card-background-fill-model: cover; --card-background-opacity: 100;">
                  <div class="card--content goods-sell--layout" :class="{
                     ...
                     <div class="" :class="{
                        ...
                        <span role="img" class="anticon goods-sell--icon-badge" style="color: rgb(255, 77, 79); top: -11px; font-size: 45px; left: 0px;">
                           <svg width="1em" height="1em" fill="currentColor" aria-hidden="true" focusable="false" class="">
                              <use xlink:href="#icon-hot"></use>
                           </svg>
                        </span>
                        <span role="img" class="anticon goods-sell--icon-badge-bg" style="top: -11px; font-size: 45px; left: 0px;">
                           <svg width="1em" height="1em" fill="currentColor" aria-hidden="true" focusable="false" class="">
                              <use xlink:href="#icon-hot_dise"></use>
                           </svg>
                        </span>
                        <div class="goods-sell--image" :class="{
                           ...getClasses,
                           ...
                           <img class="image--content" :src="product.featured_image" alt=" ">
                        </div>



                        <div class="goods-sell--footerWrap" :class="{
                           ...getClasses,
                        }">
                           <div class="goods-sell--title-wrap">
                              <div style="max-height: 34px;">
                                 <div class="text--container goods-sell--text goods-sell--title" :class="{
                                    ...getClasses,
                                 }" style="font-weight: 500; font-size: 14px; line-height: 20px;">Product Name</div>
                              </div>
                              <div class="goods-sell--sell-point">Selling Points</div>
                           </div>
                           <div class="goods-sell--price-wrap">
                              <div class="text--container goods-sell--text goods-sell--price-small-image" style="font-weight: 600; font-size: 16px; line-height: 22px; height: 22px;"><span style="margin-right: 4px;">US$ 0</span><span class="goods-sell--pre-price"> </span></div>
                           </div>
                           <div class="goods-sell--btn-wrap"><button type="submit" class="adm-button adm-button-default adm-button-mini adm-button-shape-default goods-sell--btn" style="position: absolute;"><span>Buy now</span></button></div>
                        </div>
                     </div>

                     <template x-if="section.settings.style == 'bn-6'">
                        <div class="goods-sell--btn-ROUND_CARD">
                           <button type="submit" class="goods-sell--btn goods-sell--button">
                              <span>Buy now</span>
                           </button>
                        </div>
                     </template>
    ...
    @endphp
      <section class="list-content section-content wire-section ![background:transparent]"  :class="{
