<div >
    <div x-data="builder__sectionTipjar">
            ...
            <div class="website-section !block">
                <div class="design-navbar">
                    <ul >
                       ...
                       <li class="!pl-0" x-text="!section.content.title ? '{{ __('Tipjar') }}' : section.content.title"></li>
                    ...
                    <div class="tab-content-box mt-0">
                        <div class="tab-content">
                            <div x-cloak x-show="__tab == 'content'" data-tab-content>
                                <x-livewire::components.bio.sections.tipjar.partial.edit.content/>
                            </div>
                            <div x-cloak x-show="__tab == 'style'" data-tab-content>
                                <x-livewire::components.bio.sections.tipjar.partial.edit.style/>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  @script
  <script>
      Alpine.data('builder__sectionTipjar', () => {
         return {
            autoSaveTimer: null,
            __tab: 'content',
            __page: '-',
            ...
            create_price(){
               let item = {
                  name: Math.floor(Math.random() * (1000 - 10 + 1)) + 10
               };
               this.section.content.prices.push(item);
            },

            remove_price(index){
                this.section.content.prices.splice(index, 1);
            },
            ...
            init(){
               ...
               if(this.section.content.prices === undefined || this.section.content.prices == null){
                this.section.content.prices = [];
               }
            }
         }
      });
