<div class="w-[100%]">
    <div class="flex flex-col p-2">
        ...
        <div class="w-[100%] h-10 bg-gray-200 p-3 rounded-t-xl !bg-cover !bg-center" style="-webkit-clip-path: url(#banner-shapes-slant-right-mask);" :style="{
            'background': site.banner ? `url(${$store.builder.getMedia(site.banner)})` : 'rgb(238 238 238/1)'
        }"></div>

        <div class="flex items-center -mt-5 relative overflow-hidden justify-start">
