                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="custom-color !block">
                                                ...
                                                <div class="input-box !pb-0">
                                                    <div class="input-group">
                                                        <input type="color" class="input-small input-color" x-model="site.settings.color" :style="{
                                                                ...
                                                                <div class="input-box !pb-0">
                                                                    <div class="p-1 flex items-center gap-2">
                                                                        <div class="input-group !border-0">
                                                                            <input type="color" class="input-small input-color !rounded-lg" x-model.debounce.200ms="color_1" :style="{
                                                                            'background-color': color_1,
                                                                            }" maxlength="6">
                                                                        </div>
                                                                        <div class="input-group !border-0">
                                                                            <input type="color" class="input-small input-color !rounded-lg" x-model.debounce.800ms="color_2" :style="{
