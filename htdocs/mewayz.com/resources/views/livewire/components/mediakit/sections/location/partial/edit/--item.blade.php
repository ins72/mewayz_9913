<div>
   ...
   <div x-data="builder__location_item__single">
              ...
              <div class="flex-auto overflow-clip">
                 <div class="flex items-start gap-3">
                   <div class="flex flex-col gap-2 grow shrink">
                      <div class="">
                        <div>
                             <input placeholder="{{ __('Location') }}" x-model="item.content.location" type="text" class="text text-gray-600 p-0 overflow-hidden text-ellipsis !min-h-[21px] !border-0 !border-b border-solid border-gray-200 rounded-none resize-none p-2 w-[100%]">
                         </div>
                      </div>
                   </div>
                 </div>
   ...
   @script
   <script>
       Alpine.data('builder__location_item__single', () => {
          return {
