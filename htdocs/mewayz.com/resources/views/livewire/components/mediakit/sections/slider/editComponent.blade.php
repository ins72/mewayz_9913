...
?>
<div >
    <div x-data="builder__sectionSlider">
        <template x-for="item in section.items" :key="item.uuid">
            <div x-show="__page == 'section::slider::' + item.uuid">
                <div>
                    <x-livewire::components.bio.sections.slider.partial.edit.item />
                </div>
            </div>
          </template>
            ...
            <div class="website-section !block">
                <div class="design-navbar">
                    <ul >
                       ...
                       <li class="!pl-0" x-text="!section.content.title ? '{{ __('Slider') }}' : section.content.title"></li>
                    ...
                    <div class="tab-content-box">
                        <div class="tab-content">
                            <div x-cloak x-show="__tab == 'content'" data-tab-content>
                                <x-livewire::components.bio.sections.slider.partial.edit.content/>
                            </div>
                            <div x-cloak x-show="__tab == 'style'" data-tab-content>
                                <x-livewire::components.bio.sections.slider.partial.edit.style/>
                            </div>
  ...
  @script
  <script>
      Alpine.data('builder__sectionSlider', () => {
         return {
            autoSaveTimer: null,
            __tab: 'content',
            __page: '-',
