<div>
    <div x-data="builder__sectionAccordion">
        ...
        <template x-for="(item, index) in section.items" :key="item.uuid">
          <div x-show="__page == 'section::accordion::' + item.uuid">
              <div>
                  ...
                  <div class="container-small tab-content-box">
                      <div class="tab-content">
                          <div x-cloak x-show="__tab == 'content'" data-tab-content>
                              <x-livewire::sections.accordion.partial.edit.content/>
                          </div>
                          <div x-cloak x-show="__tab == 'style'" data-tab-content>
                              <x-livewire::sections.accordion.partial.edit.style />
                          </div>
                      </div>
                  </div>
              </div>
      ...
      Alpine.data('builder__sectionAccordion', () => {
         return {
            ...
            createItem(){
                ...
                window.addEventListener('section::created_section', (event) => {
                    // console.log(event.detail[0])
                    // var object = {
                    //     //...$this.section.items[$index],
                    //     ...event.detail[0]
                    // };
                    // $this.section.items[$index] = event.detail[0];
                    //$this.section.items.push(event.detail[0]);
                });
            },
            ...
            registerEvents(){
                ...
                window.addEventListener('section:i:' + this.section.uuid, (event) => {
                    $this.__page = 'section::accordion::' + event.detail;
                });
