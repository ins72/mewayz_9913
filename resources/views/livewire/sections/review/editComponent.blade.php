<div wire:ignore>
  ...
  <div x-data="builder__sectionReview">
    ...
    <template x-for="(item, index) in section.items" :key="item.uuid">
      <div x-show="__page == 'section::review::' + item.uuid">
          <div>
              <x-livewire::sections.review.partial.edit.items />
          </div>
      </div>
    </template>
              ...
              <div class="container-small tab-content-box">
                  <div class="tab-content">
                      <div x-cloak x-show="__tab == 'content'" data-tab-content>
                          <x-livewire::sections.review.partial.edit.content/>
                      </div>
                      <div x-cloak x-show="__tab == 'style'" data-tab-content>
                          <x-livewire::sections.review.partial.edit.style />
                      </div>
                  </div>
              </div>
          </div>
  ...
  @script
  <script>
      Alpine.data('builder__sectionReview', () => {
         return {
            autoSaveTimer: null,
            __tab: 'content',
            __page: '-',
            ...
            __delete_item(item_id){
                ...
                if(this.section.items.length <= 3){
                    this.section.settings.display = 'grid';
                }
            },
            ...
            registerEvents(){
                ...
                window.addEventListener('section:i:' + this.section.uuid, (event) => {
                    $this.__page = 'section::review::' + event.detail;
                });
