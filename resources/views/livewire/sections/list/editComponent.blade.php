<div wire:ignore>
    ...
    <div x-data="builder__sectionList">
        ...
        <template x-for="(item, index) in section.items" :key="item.uuid">
          <div x-show="__page == 'section::list::' + item.uuid">
              <div>
                  <x-livewire::sections.list.partial.edit.items />
              </div>
          </div>
        </template>
                  ...
                  <div class="container-small tab-content-box">
                      <div class="tab-content">
                          <div x-cloak x-show="__tab == 'content'" data-tab-content>
                              <x-livewire::sections.list.partial.edit.content/>
                          </div>
                          <div x-cloak x-show="__tab == 'style'" data-tab-content>
                              <x-livewire::sections.list.partial.edit.style />
                          </div>
                      </div>
                  </div>
              </div>
