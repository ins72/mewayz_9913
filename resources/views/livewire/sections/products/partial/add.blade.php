...
<div>
   ...
   <div x-data="builder__products_add">
      <div>
                    ...
                    <div>
                        <div class="contact-list flex items-center justify-center px-5 py-3" >
                            ...
                            <div class="flex justify-end gap-1 w-auto ml-auto">
                                <a @click="importProduct(item)" class="yena-black-btn !h-[28px] gap-2">{!! __i('--ie', 'synchronize') !!}{{ __('Import') }}</a>
                            </div>
                        </div>
                    </div>
                </template>
                <a href="{{ route('dashboard-store-index') }}" class="yena-black-btn gap-2 mt-2">{!! __i('Building, Construction', 'store') !!}{{ __('Create Product') }}</a>
              </form>
            </div>
         </div>
      </div>
    ...
    @script
    <script>
        Alpine.data('builder__products_add', () => {
           return {
