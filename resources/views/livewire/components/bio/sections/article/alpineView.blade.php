<div>
    <div x-data="builder__article_section_view">
       <div :class="{
         'custom-styles-link': site.settings.__theme !== 'default'
       }">

        
         <template bit-component="article-template">
            <div>
         ...
         <div class="builder-block -article-block g--block-o w-[100%] h-full" :class="{
                     ...
                     <div>
                        <div class="sandy-accordion m-0" :class="{
                           ...
                           <div class="sandy-accordion-body mt-5 !pb-0" x-show="expanded" x-collapse>
                              <div x-bit:article-template></div>
                           </div>
                       </div>
                     </div>
                  </template>
    ...
    @script
    <script>
       Alpine.data('builder__article_section_view', () => {
          return {
            show_modal: false,
