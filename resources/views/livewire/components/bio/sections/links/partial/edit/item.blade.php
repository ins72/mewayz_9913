                                        ...
                                        <template x-if="item.content.customize">
                                            <div class="flex flex-col gap-2">
                                                ...
                                                <div class="input-box">
                                                   ...
                                                   <div class="input-group align-type">
                                                      <button class="btn-nav" type="button" @click="item.content.align = 'left'" :class="{'active': item.content.align == 'left'}">
                                                         {{ __('Left') }}
                                                      </button>
                                                      <button class="btn-nav" type="button" @click="item.content.align = 'center'" :class="{'active': item.content.align == 'center'}">
                                                         {{ __('Center') }}
                                                      </button>
                                                      <button class="btn-nav" type="button" @click="item.content.align = 'right'" :class="{'active': item.content.align == 'right'}">
                                                         {{ __('Right') }}
                                                      </button>
                                                   </div>
                                                </div>
