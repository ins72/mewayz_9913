<div class="w-[100%]">
    <div class="flex flex-col mt-2">
        <div class="w-32 h-32 bg-gray-200 p-3 rounded-md mx-auto flex items-center justify-center flex-col !bg-cover !bg-center !truncate" :style="{
            ...
            <template x-if="!site.logo">
                <div class="h-8 w-8 bg-gray-200 p-3 border-2 border-white border-solid rounded-full mt-auto"></div>
            </template>
            <template x-if="site.logo">
                <img alt=" " class="h-8 w-8 bg-gray-200 border-2 border-white border-solid rounded-full mt-auto object-cover" :src="$store.builder.getMedia(site.logo)">
            </template>

            <div class="flex flex-col items-center !mt-1 px-4">
