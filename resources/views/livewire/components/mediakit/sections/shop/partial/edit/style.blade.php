      ...
      <div class="mt-2 banner-text-size">
         <form>
            ...
            <template x-if="section.settings.display == 'grid'">
               <div class="input-box" x-data="{__showing: 'desktop'}">
                  ...
                  <div class="input-group">
                     ...
                     <input type="range" class="input-small range-slider !rounded-l-none" :class="{'!hidden': __showing !== 'desktop'}" min="1" max="2" step="1" x-model="section.settings.desktop_grid">
                     <input type="range" class="input-small range-slider !rounded-l-none" :class="{'!hidden': __showing !== 'mobile'}" min="1" max="1" step="1" x-model="section.settings.mobile_grid">
            ...
            <div class="input-box" x-data="{__showing: 'desktop'}">
               ...
               <div class="input-group">
                  <input type="range" class="input-small range-slider !rounded-l-none" :class="{'!hidden': __showing !== 'desktop'}" min="400" max="600" step="5" x-model="section.settings.desktop_height">

                  <input type="range" class="input-small range-slider !rounded-l-none" :class="{'!hidden': __showing !== 'mobile'}" min="400" max="600" step="5" x-model="section.settings.mobile_height">
