                                    ...
                                    <ul >
                                        ...
                                        <li>
                                          <div class="input-box !mt-0">
                                              <div class="input-group !border-0">
                                                  <div class="switchWrapper">
                                                      <input id="set-hide-header" type="checkbox" class="switchInput !border-0" x-model="currentPage.hide_header" :checked="currentPage.hide_header">
                                                      <label for="set-hide-header" class="switchLabel">{{ __('Hide header') }}</label>
                                                      <div class="slider"></div>
                                                  </div>
                                              </div>
                                          </div>
                                        ...
                                        <li @click="duplicatePage()">
                                          <a  name="duplicate">{{ __('Duplicate page') }}</a>
                                        </li>


                                        <li class="mb-2" @click="deletePagePrompt=!deletePagePrompt">
                                            <a class="delete-page-link" name="delete">{{ __('Delete page') }}</a>
                                            

                                            <div class="card-button mt-1 flex gap-2" @click="$event.stopPropagation();" :class="{
                                             '!hidden': !deletePagePrompt
                                            }">
                                             <button class="btn btn-medium neutral !h-8 !flex !items-center !justify-center !rounded-full" type="button" @click="deletePagePrompt=!deletePagePrompt">{{ __('Cancel') }}</button>
                           
                                             <button class="btn btn-medium !bg-[var(--c-red)] !text-[var(--c-light)] !h-8 !flex !items-center !justify-center !rounded-full" @click="deletePage(); deletePagePrompt=false;">{{ __('Yes, Delete') }}</button>
                                          </div>
                                        </li>
                                    </ul>
                                </div>
         ...
         <div class="overlay backdrop delete-overlay" :class="{
             ...
             <div class="delete-site-card !border-0 !rounded-2xl !shadow-lg" @click="$event.stopPropagation()">
                <div class="overlay-card-body !rounded-2xl">
                   ...
                   <p class="mt-4 mb-4 text-[var(--t-m)] text-center leading-[var(--l-body)] text-[var(--c-mix-3)] w-3/5 ml-auto mr-auto">{{ __('Your site will be moved to "trashed" folder, you will be able to restore it or delete it permanently.') }}</p>
