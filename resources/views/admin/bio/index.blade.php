       ...
       <div class="border-b border-solid border-gray-300 w-[100%] my-4 flex"></div>
        ...
        <div class="flex items-center h-6">
           <h2 class="text-lg font-semibold ">
               {!! __icon('interface-essential', 'browser-web-link', 'w-6 h-6 inline-block') !!}
               <span class="ml-2">{{ __('All LinkinBio') }}</span>
           </h2>
        </div>
                        ...
                        <div class="--thumbnail-inner" x-intersect="$store.builder.rescaleDiv($root)">
                           ...
                           <div class="page-type-options !p-0 !m-0">
                              <div class="page-type-item !h-[130px] !h-zz[120px]">
                                 @if (empty($item->logo))
                                 <div class="rounded-md p-2 bg-[#eee] !h-full !w-[100%] default flex items-center justify-center">
                                    <div>
                                       {!! __i('--ie', 'image-picture', 'text-gray-300 w-10 h-10') !!}
                                    </div>
                                 </div>
                                 @else
