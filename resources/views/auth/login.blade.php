    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p class="auth-subtitle">Sign in to your Mewayz account</p>
            </div>
            ...
            <div class="oauth-buttons">
                <a href="{{ route('oauth.redirect', 'google') }}" class="oauth-button">
                ...
                <a href="{{ route('oauth.redirect', 'apple') }}" class="oauth-button">
            ...
            <form method="POST" action="{{ route('login') }}" class="auth-form">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" class="form-input" required autocomplete="email" placeholder="Enter your email" value="{{ old('email') }}">
                </div>
