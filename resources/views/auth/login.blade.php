            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.875rem; color: var(--text-secondary);">
                        <input type="checkbox" name="remember" style="width: 1rem; height: 1rem; accent-color: var(--accent-primary);">
                        Remember me
                    </label>
                    
                    <a href="{{ route('password.request') }}" style="color: var(--accent-primary); text-decoration: none; font-size: 0.875rem;">
                        Forgot password?
                    </a>
                </div>
