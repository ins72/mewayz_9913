    ...
    public function createService(Request $request)
    {
        ...
        try {
            ...
            $service = BookingService::create([
                ...
                'buffer_time_before' => $request->buffer_time_before ?? 0,
                'buffer_time_after' => $request->buffer_time_after ?? 0,
                'max_advance_booking_days' => $request->max_advance_booking_days ?? 30,
                'min_notice_hours' => $request->min_notice_hours ?? 24,
