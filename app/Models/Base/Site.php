 ...
 * @property int $is_admin_selected
 * @property int $is_admin
 * @property string|null $ai_generate_prompt
 * @property string|null $workspace_permission
 * @property int $ai_completed
 * @property int $ai_generate
