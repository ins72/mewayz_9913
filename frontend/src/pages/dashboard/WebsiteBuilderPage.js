  ...
  return (
    <div className="space-y-6">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">WebsiteBuilder</h1>
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          This is the WebsiteBuilder page. Full functionality will be implemented here.
        </p>
